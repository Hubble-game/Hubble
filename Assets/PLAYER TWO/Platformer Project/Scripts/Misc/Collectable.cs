...
namespace PLAYERTWO.PlatformerProject
{
	...
	public class Collectable : MonoBehaviour
	{
		...
		[Tooltip("If true, this collectable will apply a temporary speed and jump boost to the player on collect.")]
		public bool givesSpeedJumpBoost;
		...
		{
			if (givesSpeedJumpBoost)
			{
				player.ApplySpeedJumpBoost(speedMultiplier, jumpMultiplier, boostDuration);
			}
